...
import wphx.wp.db.WpdbMysqliBoundary;
...
class WpdbMysqliBoundaryCandidateEntry
{
	static function main():Void
	{
		...
		WpdbMysqliBoundary.shouldCallQueryBoundary(true);
		WpdbMysqliBoundary.shouldCallFetchObjectBoundary(true);
