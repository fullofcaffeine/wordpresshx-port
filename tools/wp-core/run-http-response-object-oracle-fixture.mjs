...
const ISSUE = {
  id: "wordpresshx-l76.18.25",
  external_ref: "WPHX-312.38",
  title: "WPHX-312.38 - Add HTTP response object oracle fixture"
};
const RECORDED_AT = "2026-06-27T00:00:00.000Z";
const UPSTREAM_ROOT = "../wordpress-develop";
const RUNNER = "tools/wp-core/run-http-response-object-oracle-fixture.mjs";
const OUT_ROOT = "build/wp-core/wphx-312-38";
const ORACLE_ROOT = `${OUT_ROOT}/oracle`;
const CANDIDATE_ROOT = `${OUT_ROOT}/candidate`;
const PROBE = `${OUT_ROOT}/probe.php`;
const OUT = "manifests/wp-core/wphx-312-38-http-response-object-oracle-fixture.v1.json";
const OWNERSHIP = "manifests/ownership/wphx-312-38-http-response-object-oracle-fixture.v1.json";
const RECEIPT = "receipts/wp-core/wphx-312-38-http-response-object-oracle-fixture.v1.json";
...
function ownershipManifest(manifestSha) {
  return {
    ...
    manifest_id: "ownership:wp-core/http-response-object-oracle-fixture",
    issue: {
      id: ISSUE.id,
    ...
    unit: {
      ...
      public_contract:
        "This fixture executes copied WordPress 7.0 wp-includes/class-wp-http-response.php in isolated PHP CLI probes with a deterministic absint stub. It observes constructor data/status/header initialization, absint status coercion, get/set data and headers, single-header replace behavior, single-header append behavior when replace=false, direct jsonSerialize handoff to current response data, and json_encode public-property serialization without claiming REST server dispatch, Requests transport integration, live HTTP behavior, installed distribution behavior, or generated public PHP ownership."
    },
    ownership_state: "oracle_mirror_behavior_fixture",
    bridge: {
      exists: true,
      kind: "copied-oracle-public-php-with-stubbed-absint-boundary",
      removal_gate:
        "Replace copied public PHP with generated original-path adapters and pass REST dispatch, Requests bridge, installed HTTP routes, selected upstream HTTP/REST PHPUnit, and ecosystem fixtures before claiming public PHP ownership."
    },
    owned_paths: [RUNNER, OUT, OWNERSHIP, RECEIPT],
    generated_paths: [OUT, OWNERSHIP, RECEIPT, OUT_ROOT],
    verification: {
      oracle_commands: [
        "npm run wp:core:wphx-312-http-response-object-oracle-fixture",
        "npm run wp:core:wphx-312-http-response-object-oracle-fixture:check",
        "npm run receipts:validate",
        "npm run beads:validate"
      ],
      receipt_refs: ["receipt:wphx-312-38-http-response-object-oracle-fixture"],
...
async function main() {
  ...
  const manifest = {
    schema: "wphx.wp-core-http-response-object-oracle-fixture.v1",
    ...
    fixture: {
      ...
      side_effect_policy: {
        ...
        php_cli: true,
        runtime_stubs:
          "absint is a deterministic WordPress-compatible stub; copied class-wp-http-response.php remains the executed public HTTP response source."
      },
      public_abi_policy: {
    ...
    remaining_gaps: [
      {
        ...
        detail:
          "The fixture observes the response object in isolation. REST request dispatch, controller handoff, and installed REST HTTP behavior remain covered by separate WPHX-311 and later distribution gates."
      },
      {
        id: "requests-transport-integration-not-executed",
        owner: ISSUE.external_ref,
        detail:
          "The fixture does not execute live HTTP transport, Requests response conversion, redirects, cookies, proxy, TLS, or network I/O."
      },
      {
        id: "installed-distribution-behavior-not-executed",
        owner: ISSUE.external_ref,
        detail:
          "The fixture uses PHP CLI with a deterministic absint stub rather than an installed WordPress distribution or plugin/theme ecosystem routes."
      },
      {
  ...
  const receipt = {
    ...
    id: "receipt:wphx-312-38-http-response-object-oracle-fixture",
    issue: ISSUE,
    recorded_at: RECORDED_AT,
    artifacts: [
      { path: OUT, role: "WP_HTTP_Response oracle-source-mirror fixture manifest" },
      { path: OWNERSHIP, role: "ownership manifest for copied-oracle HTTP response object boundary" },
