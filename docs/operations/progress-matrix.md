...
Source checkpoint: `WPHX-307.02 posts/query adapter-contract candidate`
Tracking issue: `WPHX-000.02`

## Super Progress

Current super progress toward "WordPress completely in Haxe and functional": **38.4%**.
...
| WordPress PHP runtime Haxe ownership | 40 | 19 | 7.6 | `WPHX-300` has verified vertical slices, first-party PHP manifest ownership/split closure, user/auth and posts/query Haxe adapter-contract candidates, auth-domain oracle fixtures, and a WPHX-307 posts/query surface inventory, but much of Core remains unported |
