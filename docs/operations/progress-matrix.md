...
Source checkpoint: `WPHX-308.05 taxonomy/comment query-state fixture`
Tracking issue: `WPHX-000.02`

## Super Progress

Current super progress toward "WordPress completely in Haxe and functional": **40.4%**.
...
| WordPress PHP runtime Haxe ownership | 40 | 24 | 9.6 | `WPHX-300` has verified vertical slices, first-party PHP manifest ownership/split closure, user/auth and posts/query Haxe adapter-contract candidates, auth-domain oracle fixtures, WPHX-307 posts/query, post CRUD/status, post metadata/cache, post revisions adapter-contract evidence, WP_Query runtime ABI/query-state fixture evidence, and the first WP_Query live MySQL SQL/result parity fixture, and WPHX-308 taxonomy/comment surface inventory plus first typed taxonomy/comment adapter-contract evidence, but much of Core remains unported |
...
| `WPHX-300` | WordPress PHP core | open | 8/8 original direct children closed; WPHX-306 is closed; WPHX-307 has active adapter-contract, runtime ABI/query-state, and initial live DB SQL/result evidence; WPHX-308 is active with surface inventory, first adapter-contract candidate, CRUD oracle fixture, count/cache invalidation oracle fixture, and query-state oracle fixture; WPHX-309 through WPHX-320 remain seeded follow-up domains | Bootstrap, hooks, error/formatting/escaping/KSES, options/cache, wpdb, REST, multisite, first-party PHP manifest/split closure, users/auth adapter-contract/domain-closure evidence, posts/query surface inventory, typed posts/query, post CRUD/status, post metadata/cache, post revisions Haxe adapter-contract candidates, WP_Query runtime ABI/query-state fixture, WP_Query live MySQL SQL/result fixture, taxonomy/comment surface inventory, first typed taxonomy/comment adapter-contract candidate, taxonomy/comment CRUD oracle fixture, taxonomy/comment count/cache invalidation fixture, and taxonomy/comment query-state fixture have receipts; broad Core implementation remains open through remaining seeded follow-up domains | Continue WPHX-307 with selected upstream posts/query/meta/revisions PHPUnit ratchets, MariaDB/PHP-version live DB expansion, and installed-distribution query gates while WPHX-308 proceeds with live DB SQL/result parity and selected upstream taxonomy/comment PHPUnit ratchets |
