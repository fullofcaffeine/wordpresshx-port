...
Source checkpoint: `WPHX-310.04 theme JSON/global styles oracle fixture`
Tracking issue: `WPHX-000.02`

## Super Progress

Current super progress toward "WordPress completely in Haxe and functional": **43.2%**.
...
| WordPress PHP runtime Haxe ownership | 40 | 30.6 | 12.2 | `WPHX-300` has verified vertical slices, first-party PHP manifest ownership/split closure, bounded WPHX-306 users/auth, WPHX-307 posts/query, WPHX-308 taxonomy/comment, WPHX-309 routing/template domain closures, plus WPHX-310 surface inventory, a first theme/template typed Haxe adapter-contract candidate, theme support/template oracle-source-mirror evidence, and a bounded WP_Theme_JSON/global styles fixture, but much of Core remains unported |
