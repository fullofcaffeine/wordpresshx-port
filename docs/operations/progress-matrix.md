...
Source checkpoint: `WPHX-308.04 taxonomy/comment count and cache invalidation fixture`
...
| `WPHX-300` | WordPress PHP core | open | 8/8 original direct children closed; WPHX-306 is closed; WPHX-307 has active adapter-contract, runtime ABI/query-state, and initial live DB SQL/result evidence; WPHX-308 is active with surface inventory, first adapter-contract candidate, CRUD oracle fixture, and count/cache invalidation oracle fixture; WPHX-309 through WPHX-320 remain seeded follow-up domains | Bootstrap, hooks, error/formatting/escaping/KSES, options/cache, wpdb, REST, multisite, first-party PHP manifest/split closure, users/auth adapter-contract/domain-closure evidence, posts/query surface inventory, typed posts/query, post CRUD/status, post metadata/cache, post revisions Haxe adapter-contract candidates, WP_Query runtime ABI/query-state fixture, WP_Query live MySQL SQL/result fixture, taxonomy/comment surface inventory, first typed taxonomy/comment adapter-contract candidate, taxonomy/comment CRUD oracle fixture, and taxonomy/comment count/cache invalidation fixture have receipts; broad Core implementation remains open through remaining seeded follow-up domains | Continue WPHX-307 with selected upstream posts/query/meta/revisions PHPUnit ratchets, MariaDB/PHP-version live DB expansion, and installed-distribution query gates while WPHX-308 proceeds with query-state fixtures, live DB SQL/result parity, and selected upstream taxonomy/comment PHPUnit ratchets |
