...
Source checkpoint: `WPHX-309.11 routing/template upstream PHPUnit ratchet groups`
...
| `WPHX-300` | WordPress PHP core | open | 8/8 original direct children closed; WPHX-306, WPHX-307, and WPHX-308 are closed; WPHX-309 has surface inventory, first adapter-contract candidate, routing/link oracle-state fixture, canonical/template-loader oracle fixture, installed-style routing/template HTTP gate, and selected upstream PHPUnit ratchet group scope; WPHX-310 through WPHX-320 remain seeded follow-up domains | Bootstrap, hooks, error/formatting/escaping/KSES, options/cache, wpdb, REST, multisite, first-party PHP manifest/split closure, users/auth adapter-contract/domain-closure evidence, bounded posts/query domain closure, bounded taxonomy/comment domain closure, rewrite/routing/canonical/template surface inventory, first typed routing/template adapter-contract candidate, first routing/link oracle-state fixture, canonical/template-loader oracle fixture, installed routing/template package gate, and selected upstream rewrite/canonical/link/template ratchet group scope have receipts; broad Core implementation remains open through remaining seeded follow-up domains | Continue WPHX-309 with executable provisioned upstream rewrite/canonical/link/template ratchets and eventual generated public PHP adapter replacement |
